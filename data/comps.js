const COMPS=[
 {id:'wombo',name:'Wombo',tag:'Hard-Engage Teamfight',tier:'PRIMARY',color:'#c8aa6e',
  ...
  roles:[{r:'Top',p:'Harendra',k:['Malphite','Sion','Shen','Maokai']},{r:'Jungle',p:'Geeth',k:['Wukong','Vi','Viego','Nocturne','Maokai','Shen']},{r:'Mid',p:'Steven',k:['Annie','Orianna','Galio']},{r:'ADC',p:'Shabir',k:['Caitlyn','Ashe','Jinx']},{r:'Support',p:'Eshantha',k:['Rell','Alistar','Morgana']}],
 ...
 {id:'B',name:'Lights Out',tag:'Pick & Catch',tier:'SECONDARY',color:'#0ac8b9',
  source:'claude',status:'core',
  roles:[{r:'Top',p:'Harendra',k:['Shen','Sion']},{r:'Jungle',p:'Geeth',k:['Nocturne','Vi','Kha\'Zix','Shen']},{r:'Mid',p:'Steven',k:['LeBlanc','Annie','Diana']},{r:'ADC',p:'Shabir',k:['Jinx','Caitlyn']},{r:'Support',p:'Eshantha',k:['Morgana','Thresh','Rell']}],
 ...
 {id:'ftb',name:'Front-to-Back',tag:'Stable Teamfight',tier:'SAFE',color:'#4b9cff',
  source:'claude',status:'core',
  roles:[{r:'Top',p:'Harendra',k:['Sion','Malphite','Maokai']},{r:'Jungle',p:'Geeth',k:['Viego','Briar','Warwick','Maokai','Shen']},{r:'Mid',p:'Steven',k:['Orianna','Lux','Annie']},{r:'ADC',p:'Shabir',k:['Caitlyn','Jinx','Kalista']},{r:'Support',p:'Eshantha',k:['Alistar','Rell','Braum']}],
 ...
 {id:'D',name:'Bug Hunt',tag:'Dive / Assassinate',tier:'FLEX',color:'#c586e0',
  source:'claude',status:'core',
  roles:[{r:'Top',p:'Harendra',k:['Malphite','Sion','Maokai']},{r:'Jungle',p:'Shabir',k:['Kha\'Zix','Viego']},{r:'Mid',p:'Steven',k:['Diana','Akali','LeBlanc']},{r:'ADC',p:'Geeth',k:['Miss Fortune','Caitlyn']},{r:'Support',p:'Eshantha',k:['Rell','Alistar']}],
 ...
 {id:'E',name:'Bunker',tag:'Protect-the-Carry',tier:'DEV',color:'#7e8db0',
  source:'claude',status:'core',
  roles:[{r:'Top',p:'Harendra',k:['Sion','Malphite','Maokai']},{r:'Jungle',p:'Geeth',k:['Viego','Warwick','Maokai']},{r:'Mid',p:'Steven',k:['Lux','Orianna','Morgana']},{r:'ADC',p:'Shabir',k:['Jinx','Kalista']},{r:'Support',p:'Eshantha',k:['Seraphine','Braum','Morgana']}],
...
,{id:'control',name:'Control Teamfight',tag:'Proven winner (Jun 6)',tier:'PRIMARY',color:'#3fb950',
  source:'claude',status:'core',
  roles:[{r:'Top',p:'Harendra',k:['Shen','Malphite','Maokai']},{r:'Jungle',p:'Geeth',k:['Viego','Wukong','Shen','Maokai']},{r:'Mid',p:'Steven',k:['Orianna','Lux']},{r:'ADC',p:'Shabir',k:['Caitlyn','Ashe']},{r:'Support',p:'Eshantha',k:['Rell','Alistar']}],
