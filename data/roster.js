...
const PLAYERS=[
 ...
 {name:'Harendra',handle:'Merkedi#Neru',rank:'Bronze IV*',init:'H',roles:['Top','Jungle'],clash:'Top',
  ...
  note:'Widest, shallowest pool — our #1 improvement lever. Collapse to 3 core tanks: Malphite / Sion / Shen. Maokai is an interchangeable engage-tank option (same archetype).'},
 ...
 {name:'Geeth',handle:'Synister#ezclp',rank:'Gold I 🔥',init:'G',roles:['Jungle','ADC','Mid','Top','Support'],clash:'Jungle',
  ...
  note:'True all-role flex & best/hottest player. Default jungle (Viego 69%). Also has Shen (83%) and Maokai (67%) as tank/engage jungle options. The swing piece every comp is built around.'}
];
